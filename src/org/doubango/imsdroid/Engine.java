...
public class Engine extends NgnEngine{
	...
	private static final String CONTENT_TITLE = "6NUM";
	...
	static {
		System.load(String.format("/data/data/org.doubango.sixnum/lib/libtinyWRAP.so", Main.class.getPackage().getName()));
