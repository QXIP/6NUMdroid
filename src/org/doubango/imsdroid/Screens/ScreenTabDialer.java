...
public class ScreenTabDialer  extends BaseScreen {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		tabButton1 = (Button) findViewById(R.id.screen_tabButton1);
		tabButton2 = (Button) findViewById(R.id.screen_tabButton2);
		tabButton3 = (Button) findViewById(R.id.screen_tabButton3);
		...
		tabButton1.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View v) {
				if(mSipService.isRegistered()){
					mScreenService.show(ScreenTabDialer.class);
				}
			}
		});
	...
	public boolean back(){
		...
		boolean ret = mScreenService.show(ScreenTabDialer.class);
		if(ret){
