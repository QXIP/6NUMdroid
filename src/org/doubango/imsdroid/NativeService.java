		...
		mBroadcastReceiver = new BroadcastReceiver() {
			...
			public void onReceive(Context context, Intent intent) {
				...
				if(ConnectivityManager.CONNECTIVITY_ACTION.equals(action)){
					...
					Log.d("6NUM-NET", "Network info ["+lNetworkInfo+"]");
					...
					switch((type = args.getEventType())){
						...
						default:
							...
							if(mEngine.getSipService().isRegistered()){
								...
								mEngine.showAppNotif(bTrying ?R.drawable.bullet_ball_glass_grey_16 : R.drawable.bullet_ball_glass_grey_16, "Not Registered (Idle)");
